...
import com.example.playlistmaker.ui.medialibrary.create_playlist.view_model.CreatePlaylistViewModel.Companion.KEY_PLAYLIST_COVER_URI
...
open class CreatePlaylistFragment : Fragment() {
    ...
    protected open fun initCompleteButton() {
        binding?.apply {
            buttonComplete.setOnClickListener { viewModel.onCompleteButtonClicked() }
        }
    }
